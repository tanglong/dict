...
// System.Net.Sockets.Socket[]
struct SocketU5BU5D_t4085652466  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) Socket_t150013987 * m_Items[1];

public:
	inline Socket_t150013987 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline Socket_t150013987 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, Socket_t150013987 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
